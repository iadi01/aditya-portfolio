      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 py-20 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-14 xl:gap-24">
          ...
          <section className="relative z-10 order-2 lg:order-1 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            {/* OOPS Badge */}
            <div className="mb-4 inline-block rounded-xl border-4 border-black bg-pink-400 px-6 py-2 shadow-[6px_6px_0px_black]">
            ...
            <h1 className="leading-none font-black tracking-tight text-[110px] sm:text-[150px] md:text-[180px] lg:text-[210px] xl:text-[240px] select-none flex justify-center lg:justify-start">
              <span className="block text-[#6E5CFE]" style={{ WebkitTextStroke: "4px black", textShadow: "8px 8px 0px black" }}>
                4
              </span>
              <span className="-ml-4 sm:-ml-6 text-[#D2F801]" style={{ WebkitTextStroke: "4px black", textShadow: "8px 8px 0px black" }}>
                0
              </span>
              <span className="-ml-4 sm:-ml-6 text-[#FF72B6]" style={{ WebkitTextStroke: "4px black", textShadow: "8px 8px 0px black" }}>
                4
              </span>
            </h1>
            ...
            {/* Description Box */}
            <div className="mt-10 max-w-xl rounded-2xl border-4 border-black bg-white p-7 shadow-[8px_8px_0px_black] text-left">
            ...
            <button
              ...
              className="mt-10 inline-flex items-center gap-3 px-7 sm:px-10 py-5 rounded-xl border-4 border-black bg-[#D2F801] shadow-[8px_8px_0_black] text-lg sm:text-2xl font-black transition duration-300 hover:translate-x-1 hover:-translate-y-1 hover:shadow-none cursor-pointer text-black"
            >
              TAKE ME HOME
